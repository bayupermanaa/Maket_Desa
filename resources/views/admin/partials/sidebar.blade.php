<aside class="w-72 bg-gray-900 text-white min-h-screen p-6 flex-shrink-0">
    ...
    <nav class="space-y-1">
        ...
        <a href="{{ route($routePrefix . '.pengajuan-surat.index') }}"
           class="flex items-center gap-3 px-5 py-4 rounded-2xl font-medium transition {{ request()->routeIs($routePrefix . '.pengajuan-surat.*') ? 'bg-orange-600 text-white' : 'hover:bg-gray-800' }}">
            ?? Pengajuan Surat
        </a>
