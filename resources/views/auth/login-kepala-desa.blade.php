<x-app-layout>
    <x-slot name="title">Login Kepala Desa - MAKET DESA</x-slot>
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="p-8">
                    ...
                    <div class="mt-8 text-center">
                        <x-public-back-link href="{{ route('dashboard') }}" label="Kembali ke Dashboard" class="justify-center text-gray-500 hover:text-emerald-600" />
                    </div>
                </div>
            </div>
        </div>
