<x-app-layout>
    <x-slot name="title">Login Admin - MAKET DESA</x-slot>
        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-12 text-center text-white">
                    ...
                    <p class="text-blue-100 mt-1">Admin MAKET DESA</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="mt-8 text-center">
                        <x-public-back-link href="{{ route('dashboard') }}" label="Kembali ke Dashboard" class="justify-center text-gray-500 hover:text-blue-600" />
                    </div>
                </div>
            </div>
        </div>
