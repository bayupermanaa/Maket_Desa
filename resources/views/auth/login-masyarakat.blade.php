<x-app-layout>
    <x-slot name="title">Login Masyarakat - MAKET DESA</x-slot>
        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                <div class="bg-gradient-to-r from-orange-600 to-amber-500 px-8 py-12 text-center text-white">
                    ...
                    <p class="text-orange-100 mt-1">Warga MAKET DESA</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="mt-8 text-center">
                        <x-public-back-link href="{{ route('login') }}" label="Kembali Pilih Role" class="justify-center text-gray-500 hover:text-orange-600" />
                    </div>
                </div>
            </div>
        </div>
