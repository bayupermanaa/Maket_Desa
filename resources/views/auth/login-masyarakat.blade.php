<x-app-layout>
    <x-slot name="title">Login Masyarakat - Desa Maket</x-slot>
        ...
        <div class="max-w-md w-full">
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                <div class="bg-gradient-to-r from-orange-600 to-amber-500 px-8 py-12 text-center text-white">
                    ...
                    <p class="text-orange-100 mt-1">Warga Desa Maket</p>
                </div>
                ...
                <div class="p-8">
                    ...
                    <div class="mt-8 text-center">
                        <a href="{{ route('login') }}" class="text-gray-500 hover:text-orange-600 flex items-center justify-center gap-2">
                            ← Kembali Pilih Role
                        </a>
                    </div>
                </div>
