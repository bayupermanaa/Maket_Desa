<x-app-layout>
    <x-slot name="title">Login - MAKET DESA</x-slot>
    ...
    <div class="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
            <div class="bg-orange-600 px-8 py-10 text-center text-white">
                ...
                <h1 class="text-2xl font-bold">MAKET DESA</h1>
            ...
            <div class="p-8 text-center">
                ...
                <div class="mt-8 text-sm text-gray-500">
                    <x-public-back-link href="{{ route('dashboard') }}" label="Kembali ke Dashboard" class="justify-center" />
                </div>
            </div>
        </div>
    </div>
